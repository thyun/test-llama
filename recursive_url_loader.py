...
class RecursiveUrlLoader2(BaseLoader):
    ...
    def _get_child_links_recursive(
        ...
        try:
            ...
            response = requests.get(url, auth=('1001291', '--------'))
#            response = requests.get(url, timeout=self.timeout, headers=self.headers, auth=('1001291', '------'))
